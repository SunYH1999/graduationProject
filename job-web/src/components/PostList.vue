<template>
	<div class="post-list">
		...
		<el-table :data="tableData" style="width: 100%">
			...
			<el-table-column label="薪资" width="220">
				<template slot-scope="scope">
					<span style="margin-left: 10px">{{scope.row.salary}}</span>
				</template>
			</el-table-column>

			<el-table-column label="工龄要求" width="220">
				<template slot-scope="scope">
					<span style="margin-left: 10px">{{scope.row.workYear}}</span>
				</template>
			</el-table-column>

			<el-table-column label="所需人数" width="220">
				<template slot-scope="scope">
